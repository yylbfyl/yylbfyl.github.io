...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/yylbfyl',     // Internal links should not include the base path, as it is automatically added
  ...
  links: [
    {
      ...
      url: 'https://github.com/yylbfyl',     // `pnpm add @iconify-json/<icon-set-name>`
    },
  ],
}
